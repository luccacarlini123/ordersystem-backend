...
public class DBService {
	...
	public void instantiateTestDatabse() throws ParseException {
		...
		produtoRepo.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27,
				p28, p29, p30, p31, p32, p34, p35, p36, p37, p38, p39, p40, p41, p42, p43, p44, p45, p46, p47, p48, p49,
				p50));
		estadoRepo.saveAll(Arrays.asList(est1, est2));
		cidadeRepo.saveAll(Arrays.asList(c1, c2, c3));

		Cliente cli1 = new Cliente(null, "Lucca Carlini", "lucca.carlini18@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("21966425063", "21990836512"));
		cli1.addPerfil(Perfil.ADMIN);

		Cliente cli2 = new Cliente(null, "Maria Silva", "maria@gmail.com", "16976587764", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
